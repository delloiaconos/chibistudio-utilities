...
set PATH=%CHIBISTUDIO%\tools\GNU Tools ARM Embedded\7.0 2017q4\arm-none-eabi\bin;%PATH%
set PATH=%CHIBISTUDIO%\tools\GNU Tools ARM Embedded\7.0 2017q4\bin;%PATH%
cd eclipse
start eclipse.exe
