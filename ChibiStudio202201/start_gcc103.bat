...
set PATH=%CHIBISTUDIO%\tools\GNU Tools ARM Embedded\10.3 2021.07\arm-none-eabi\bin;%PATH%
set PATH=%CHIBISTUDIO%\tools\GNU Tools ARM Embedded\10.3 2021.07\bin;%PATH%
